...
axs[0].set_title('BANDPASS Original - PPG Signal')
axs[0].set_xlabel('Val (s)')
axs[0].set_ylabel('Amplitude')
axs[0].grid(True)


axs[1].plot(ecg_data["VAL"], filtered_ecg, color='green', label='Filtered PPG')
axs[1].set_xlabel('Val (s)')
axs[1].set_ylabel('Amplitude')
axs[1].set_title('BANDPASS filtered - PPG Signal')
axs[1].grid(True)
